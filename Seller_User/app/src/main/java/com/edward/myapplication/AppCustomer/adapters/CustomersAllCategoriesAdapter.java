...
public class CustomersAllCategoriesAdapter extends RecyclerView.Adapter<CustomersAllCategoriesAdapter.ViewHolder> {

    List<CategoryRes> ls;
    Context c;

    public CustomersAllCategoriesAdapter(List<CategoryRes> ls, Context c) {
        this.ls = ls;
        this.c = c;
    }
